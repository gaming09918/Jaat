...
TELEGRAM_BOT_TOKEN ='8465888841:AAGbZ_TubqCXmO1sUGaNHCNlWJQcZpTN7iU'
ADMIN_USER_ID = 6293907676

# GitHub Config
GITHUB_TOKEN = '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'
REPO_OWNER = 'gaming09918'
REPO_NAME = 'Jaat'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await update.message.reply_text("*❌ Access Denied! Join @PRIMEXARMY_OFFICIAL*")
        return
